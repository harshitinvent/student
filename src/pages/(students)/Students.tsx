      ...
      render: (_: any, student: Student) => (
        <div className="flex gap-2">
          ...
          <Button
            ...
            icon={
              student.is_active ? <StopOutlined /> : <CheckCircleOutlined />
            }
            onClick={() =>
              openConfirmModal(
          ...
          <Button
            className="table-action-button"
            onClick={() => openConfirmModal('delete', student)}
          >
        ...
        <ConfirmActionModal
          ...
          departmentName={
            confirmModal.student
              ? `${confirmModal.student.first_name} ${confirmModal.student.last_name}`
              : ''
          }
