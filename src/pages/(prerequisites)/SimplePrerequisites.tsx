...
export default function SimplePrerequisitesPage() {
  ...
  const [editPrerequisite, setEditPrerequisite] = useState<Prerequisite | null>(
    null
  );
      ...
      render: (code: string, record: Prerequisite) => (
        <div>
          ...
          <div className="text-sm text-gray-500">
            {record.prerequisite_course_title}
          </div>
        </div>
      ),
    },
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="mb-2 text-2xl font-bold">Prerequisites Management</h1>
        <p className="text-gray-600">
          Define course prerequisites and enrollment requirements
        </p>
      </div>
      ...
      <Card>
        <div className="mb-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Manage course prerequisites and enrollment rules
            </p>
          </div>
      ...
      >
        ...
        >
          ...
          <Form.Item
            ...
            rules={[
              { required: true, message: 'Please select prerequisite course' },
            ]}
          >
            <Select
          ...
          <Form.Item
            ...
            rules={[
              { required: true, message: 'Please select prerequisite type' },
            ]}
          >
            <Select>
              <Select.Option value="SINGLE">Single Prerequisite</Select.Option>
              <Select.Option value="AND">AND Condition</Select.Option>
              <Select.Option value="OR">OR Condition</Select.Option>
            </Select>
          </Form.Item>

          <div className="flex gap-3">
            <Button size="large" block onClick={handleModalClose}>
              Cancel
            </Button>
            <Button
              type="primary"
